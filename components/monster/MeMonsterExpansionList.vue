      ...
      <v-expansion-panel-content>
        ...
        <div v-if="showBar">
          ...
          <v-row justify="space-between">
            <v-col>
              <me-monster-bookmark v-if="bookmarkable" :type="type" :item="item" />
            </v-col>
            <v-col class="text-right">
              <me-permalink v-if="linkable" :item-id="item.RowKey" :type="type" :homebrew="!!item.homebrew" :target="newWindow ? '_blank' : '_self' " />
            </v-col>
          </v-row>
        </div>
      </v-expansion-panel-content>
